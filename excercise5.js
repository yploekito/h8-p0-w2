...
var seventh = 'it!';
console.log("###################")
console.log ("Problem : 1. Let's form a sentence")
console.log(word + " " + second +" "+ third +" "+ fourth +" " + sixth + " " + seventh)
console.log("###################")

// 2. Index Accessing - 1 by 1
console.log("Problem : 2. Index Accessing - 1 by 1")
...
console.log("Problem: 3. Breaking Sentence (Again) using Substring")
...
console.log("Problem: 4. Breaking Sentence (yet Again) and Count Each Length")
